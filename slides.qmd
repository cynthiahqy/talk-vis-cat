---
title: "Let's use Graphs, Matrices and Edge Lists improve and illuminate Ex-Post Harmonisation Procedures"
subtitle: "Crossmaps: A principled approach to ex-post data harmonisation and dataset integration"
author: 
...
apply_xmap <- function(.data, .xmap) {
    ...
    group_by(target_taxonomy) |>
    summarise(final_count = sum(part_count))
}
```
:::

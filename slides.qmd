...
::: columns
::: {.column width="75%"}
@zhouMatrixMultiplicationSQL2020 shows that matrix multiplication can be implemented using SQL operations on edge lists. Thus implementation can be done as a two-input function which:
...
::: {.callout-note}
## Useful links
  - More details on crossmaps and visualising them: [arxiv.org/abs/2308.06535](https://arxiv.org/abs/2308.06535) @huangVisualisingCategoryRecoding2023
  - {xmap} package (work in progress): [github.com/cynthiahqy/xmap](https://github.com/cynthiahqy/xmap)
  - Slides: [cynthiahuang.quarto.pub/iasc-asr-vis-cat](https://cynthiahuang.quarto.pub/iasc-asr-vis-cat)
